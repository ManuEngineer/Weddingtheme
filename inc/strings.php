...
function mym_s_built_in_defaults() {
	return array(
		'de' => array(
			...
			'mym_songs_title'          => 'Musikwünsche',
			'mym_songs_intro'          => 'Welcher Song darf an unserer Feier nicht fehlen? Schreibt uns eure Wünsche — gerne mehrere.',
			'mym_songs_f_name'         => 'Euer Name',
			'mym_songs_f_name_hint'    => '(optional)',
			'mym_songs_f_title'        => 'Song-Titel',
			'mym_songs_f_artist'       => 'Interpret',
			'mym_songs_f_add'          => '+ weiteren Song hinzufügen',
			'mym_songs_f_remove'       => 'Entfernen',
			'mym_songs_f_submit'       => 'Wünsche senden',
			'mym_songs_js_sending'     => 'Wird gesendet …',
			'mym_songs_js_thanks'      => 'Danke für eure Musikwünsche!',
			'mym_songs_js_err_title'   => 'Bitte trage mindestens einen Songtitel ein.',
			'mym_songs_js_error'       => 'Etwas ist schiefgelaufen. Bitte versuche es später erneut.',
		),
		'es' => array(
			...
			'mym_songs_title'          => 'Deseos musicales',
			'mym_songs_intro'          => '¿Qué canción no puede faltar en nuestra fiesta? Cuéntennos sus deseos, pueden ser varios.',
			'mym_songs_f_name'         => 'Su nombre',
			'mym_songs_f_name_hint'    => '(opcional)',
			'mym_songs_f_title'        => 'Título de la canción',
			'mym_songs_f_artist'       => 'Intérprete',
			'mym_songs_f_add'          => '+ añadir otra canción',
			'mym_songs_f_remove'       => 'Eliminar',
			'mym_songs_f_submit'       => 'Enviar deseos',
			'mym_songs_js_sending'     => 'Enviando …',
			'mym_songs_js_thanks'      => '¡Gracias por sus deseos musicales!',
			'mym_songs_js_err_title'   => 'Por favor indica al menos un título de canción.',
			'mym_songs_js_error'       => 'Algo salió mal. Por favor inténtalo más tarde.',
		),
	);
}
...
function mym_register_ui_strings() {
	...
	$strings = array(
		...
		array( 'mym_songs_title',           'Song requests' ),
		array( 'mym_songs_intro',           'What song can\'t be missing at our party? Send us your wishes — feel free to add more than one.' ),
		array( 'mym_songs_f_name',          'Your name' ),
		array( 'mym_songs_f_name_hint',     '(optional)' ),
		array( 'mym_songs_f_title',         'Song title' ),
		array( 'mym_songs_f_artist',        'Artist' ),
		array( 'mym_songs_f_add',           '+ Add another song' ),
		array( 'mym_songs_f_remove',        'Remove' ),
		array( 'mym_songs_f_submit',        'Send wishes' ),
		array( 'mym_songs_js_sending',      'Sending …' ),
		array( 'mym_songs_js_thanks',       'Thank you for your song requests!' ),
		array( 'mym_songs_js_err_title',    'Please enter at least one song title.' ),
		array( 'mym_songs_js_error',        'Something went wrong. Please try again later.' ),
	);
