...
function mym_assets() {
	...
	$mtn_shift_d = (int) mym_opt( 'mym_hero_mtn_shift_desktop', 0 );
	$mtn_scale_d = (int) mym_opt( 'mym_hero_mtn_scale_desktop', 100 ) / 100;
	$mtn_shift_m = (int) mym_opt( 'mym_hero_mtn_shift_mobile', 0 );
	$mtn_scale_m = (int) mym_opt( 'mym_hero_mtn_scale_mobile', 100 ) / 100;
